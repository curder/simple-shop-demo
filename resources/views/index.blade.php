                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                        <a href="product.html">
                            <img src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
                                 alt="专业空手道服" class="w-full h-48 object-cover">
                        </a>
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2">专业空手道服</h3>
                            <p class="text-gray-600 mb-4">采用优质棉质面料，透气舒适，适合日常训练和比赛使用。</p>
                            <div class="flex justify-between items-center">
                                <span class="text-blue-600 font-semibold">¥299</span>
