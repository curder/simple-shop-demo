<div class="w-full md:w-1/2">
    ...
    <div class="space-y-6">
        <div class="hidden flex items-center text-sm text-gray-500 mb-2">
            ...
            <span class="text-green-600">库存充足</span>
        </div>
        <div class="flex items-center text-sm text-gray-500 mb-4">
            <span class="mr-4">销量: 1289</span>
            <span class="mr-4">评价: 4.9/5.0</span>
            <span>收藏: 256</span>
        </div>
        <div>
            <h3 class="text-lg font-semibold mb-2 text-gray-800">商品描述</h3>
            <p class="text-gray-700">{{ $product->description }}</p>
        </div>

        @if($product->feature)
            <div class="border-t pt-4">
                <h3 class="text-lg font-semibold mb-2 text-gray-800">产品特点：</h3>
        ...
        <div class="border-t pt-4">
            <h3 class="text-lg font-semibold mb-2 text-gray-800">价格：</h3>
        ...
        <div class="flex items-center text-sm text-gray-500 mb-2">
            <span class="text-green-600">库存：{{ $this->currentVariant['stock'] ?? '-' }}</span>
        </div>

        <div class="border-t pt-4">
            <h3 class="text-lg font-semibold mb-2 text-gray-800">数量：</h3>
