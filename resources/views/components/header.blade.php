        ...
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8">
                <a wire:navigate href="{{ route('index') }}"
                   class="text-gray-600 hover:text-blue-600">@lang('header.index')</a>
                <a wire:navigate href="{{ route('about-us') }}"
                   class="text-gray-600 hover:text-blue-600">@lang('header.about-us')</a>
                <a wire:navigate href="{{ route('contact-us') }}"
                   class="text-gray-600 hover:text-blue-600">@lang('header.contact-us')</a>
            </nav>
            <div class="flex items-center space-x-4">
                <a wire:navigate href="#" class="text-gray-600 hover:text-blue-600">
